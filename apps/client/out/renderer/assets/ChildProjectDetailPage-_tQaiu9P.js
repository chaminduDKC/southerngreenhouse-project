...
import { A as useChildProject, B as useChildProjectAllocations, v as useSubProject, q as useProject, C as useUpdateChildProject, D as useMarkChildProjectUsed } from "./index-D6YZuVUF.js";
...
function ChildProjectDetailPage() {
  const { id } = useParams();
  ...
  if (!childProject) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PackageOpen, {}), title: "Child project not found", message: "This child project may have been deleted or the link is incorrect." }) });
  }
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await updateChildProject.mutateAsync({ id, data: formData });
      zt.success("Child project updated");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.5rem", fontSize: "0.9rem", color: "var(--text-secondary)", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-ghost btn-sm", onClick: () => navigate(`/subprojects/${childProject.subProjectId}`), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 16 }),
        " Back"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { cursor: "pointer" }, onClick: () => navigate(`/projects/${subProject?.projectId}`), children: project?.title || "Project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { cursor: "pointer" }, onClick: () => navigate(`/subprojects/${childProject.subProjectId}`), children: subProject?.title || "Sub-project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, color: "var(--text-primary)" }, children: childProject.title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card", style: { marginBottom: "2rem", position: "relative", overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1.5rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.8rem", fontWeight: 600, color: "var(--accent)", letterSpacing: "0.05em", marginBottom: "0.35rem" }, children: "CHILD PROJECT" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: "1.8rem", fontWeight: 700, color: "#fff", marginBottom: "0.5rem" }, children: childProject.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.75rem", alignItems: "center", color: "var(--text-secondary)", fontSize: "0.9rem" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `badge ${getStatusBadgeClass(childProject.status)}`, children: childProject.status }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Location: ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, color: "var(--text-primary)" }, children: childProject.location })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "0.5rem" }, children: [
          ...
          childProject.status !== ProjectStatus.COMPLETED && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-secondary", style: { color: "var(--accent)", borderColor: "rgba(99,102,241,0.3)" }, onClick: () => setIsMarkUsedConfirmOpen(true), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, minmax(160px, 1fr))", gap: "1rem", marginBottom: "1rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card glass-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "1.3rem", fontWeight: 600, color: "var(--success)" }, children: [
            "LKR ",
            formatCurrency(childProject.value)
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-card stat-danger glass-card", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "1.3rem", fontWeight: 600, color: "var(--danger)" }, children: [
            "LKR ",
            formatCurrency(childProject.cost)
          ] })
        ] })
      ] }),
      childProject.notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "rgba(0,0,0,0.15)", border: "1px solid var(--border)", padding: "1rem", borderRadius: "var(--radius-sm)", fontSize: "0.9rem", color: "var(--text-secondary)" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", form: "edit-child-form", className: "btn btn-primary", disabled: updateChildProject.isPending, children: updateChildProject.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Loader2, { size: 16, className: "animate-spin mr-2 inline" }),
            " Saving..."
          ] }) : "Save Changes" })
        ] }),
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "edit-child-form", onSubmit: handleUpdate, children: [
...
export {
  ChildProjectDetailPage as default
};
